...
def pagination_questions(request, selection):
  ...
  list_questions = questions[start:end]
...
def create_app(test_config=None):
  ...
  def create_question():
    ...
    new_question = {}
    new_question['question'] = body.get('question', None)
    new_question['answer'] = body.get('answer', None)
    new_question['difficulty'] = body.get('difficulty', None)
    new_question['category'] = body.get('category', None)
  ...
  def get_questions_byID(category_id):

    try:
      list_questions = Question.query.filter_by(category = str(category_id)).all()
